...
const Calendar = () => {
  ...
  return (
    <Box p={4} className="calendar">
      ...
      <ButtonGroup variant="outline" spacing="6" display={"flex"} justifyContent={"center"} marginTop={39}>
        <Button bg="transparent" color="green.500" borderColor="green.500" _hover={{ bg: "green.500", color: "white" }}>Confirmar</Button>
        <Button bg="transparent" color="red.500" borderColor="red.500" _hover={{ bg: "red.500", color: "white" }}>Cancelar</Button>
      </ButtonGroup>
    </Box>
  );
};
